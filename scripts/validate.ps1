...
if ($profile) {
    if ($profile.schema -ne 1 -or $profile.profile -ne 'qwen3.8-27b-rtx4090-3090') { Add-Error 'Profile identity/schema is incorrect.' }
    ...
    foreach ($name in @('modelSha256','mmprojSha256','chatTemplateSha256')) {
